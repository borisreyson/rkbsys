...
<form class="form-horizontal form-label-left" action="{{url('/sarpras/sarana/form-izin-keluar')}}" method="post">
        ...
        <table class="table table-striped" id="table_penumpang">
          ...
          <tbody>
            <tr>
                  ...
                  <option value="{{$vK->nik}}" selected="selected">({{$vK->nik}}) {{ucwords($vK->nama)}} [ {{ucwords($vK->nama)}} ]</option>
                  @else
                  <option value="{{$vK->nik}}">({{$vK->nik}}) {{ucwords($vK->nama)}} [ {{ucwords($vK->nama)}} ]</option>
                  @endif
                  @else
                  <option value="{{$vK->nik}}">({{$vK->nik}}) {{ucwords($vK->nama)}} [ {{ucwords($vK->nama)}} ]</option>
                  @endif
                  ...
                  <td>
                  <div class="form-control-static" id="depSect">@if(isset($pemohon)) {{ucwords($pemohon->dept)}} @if($pemohon->sect!=null) / {{ucwords($pemohon->sect)}} @endif @endif</div>
                  </td>
                  <td>              
