...
<div class="col-lg-8 col-md-12 col-sm-12">
  <div class="row">
    <div class="col-lg-6 col-xs-12">
      ...
      | 
      Pemohon
      <font color="blue" style="font-weight: bolder;"> @if(isset($pemohon->nama)) {{ucwords($pemohon->nama)}} @endif</font>
      <br><br>
    </div>
    <div class="col-lg-6 col-xs-12">
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="col-lg-12">
            ...
            ?>
          <b class="col-lg-2">Driver </b>  <span class="col-lg-9"><b>:</b> 
            @if(isset($driver->nama)) {{ucwords($driver->nama)}} @endif </span>
