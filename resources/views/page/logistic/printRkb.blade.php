...
<!-- <link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/v/bs/dt-1.11.3/b-2.0.1/b-html5-2.0.1/datatables.min.css"/> -->
...
<!-- <script type="text/javascript" src="{{url('https://mtkjobsite.com/DataTables/datatables.min.js')}}"></script> -->
<!-- <script src="{{asset('/table/jquery.dataTables.min.js')}}" nonce ></script>
<script src="{{asset('/table/dataTables.bootstrap.min.js')}}" nonce ></script>
<script src="{{asset('/table/dataTables.buttons.min.js')}}" nonce ></script>
<script src="{{asset('/table/buttons.bootstrap.min.js')}}" nonce ></script>
<script src="{{asset('/table/jszip.min.js')}}" nonce ></script>
<script src="{{asset('/table/pdfmake.js')}}" nonce ></script>
<script src="{{asset('/table/vfs_fonts.js')}}" nonce ></script>



<script src="{{asset('/table/buttons.html5.min.js')}}" nonce ></script>
<script src="{{asset('/table/buttons.print.min.js')}}" nonce ></script>
<script src="{{asset('/table/buttons.colVis.min.js')}}" nonce ></script> -->
<!-- <script src="{{asset('/table/datatables.min.js')}}" nonce ></script> -->
@include('layout.js')
