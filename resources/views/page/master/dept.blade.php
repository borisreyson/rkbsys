...
@if($k%2)
                          <tr class="even pointer">
                            <td class=" ">{{$k+1}}</td>
                            <td class=" ">{{$v->id_dept}}</td>
                            <td class=" ">{{$v->dept}}</td>
                            <td class=" " width="150px">
                              <a href="{{url('/form_dept/'.bin2hex($v->id_dept).'-'.bin2hex($v->dept).'.html')}}" class="btn btn-warning btn-xs">Edit</a>
                              <a href="{{url('/form_dept/'.bin2hex($v->id_dept).'-'.bin2hex($v->dept).'.del')}}" class="btn btn-danger btn-xs">Delete</a>
                            </td>
                          </tr>
@else
...
@endif
                ...
                <div id="paging pull-right">{{$dept->links()}}</div>
                </div>
                </div>
            </div>
        </div>
