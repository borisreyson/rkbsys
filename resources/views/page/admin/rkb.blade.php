...
@if(isset($_GET['cancel'])!="")
  <a href="{{url('/admin/rkb')}}" class="btn btn-default">RKB</a>
@else
  <!--<a href="{{url('/admin/rkb?expired=notnull')}}" class="btn btn-danger"> RKB EXPIRED</a>-->
@endif
@if(isset($_GET['close_rkb'])!="")
<a href="{{url('/admin/rkb')}}" class="btn btn-default">RKB</a>
@else
<a href="{{url('/admin/rkb?close_rkb=all')}}" class="btn btn-default">RKB Close</a>
@endif
</div>
</div>
<div class="col-md-6 col-sm-12 col-xs-12">
...
<div class="col-sm-12 col-md-9">{{$value->myStatus}}</div>
        </div>
      </div>
      </div>
    </div>
    ...
    <div class="col-xs-12" style="border-top: solid thin #000;padding-top: 5px;">
      <div class="row">
        <div class="col-lg-3 col-md-6 col-xs-12">
          <a href="#" style="display: none;" class="qty btn btn-xs btn-primary" data-id="{{$value->no_rkb}}" id="qty" data-toggle="modal" data-target="#myModal">Edit Quantity</a>
...
<div class="pull-right dropdown dropright">
                        ...
                        <ul class="dropdown-menu " role="menu">
                          <li>
                            <a href="#" class="qty" data-id="{{$value->no_rkb}}" id="qty" data-toggle="modal" data-target="#myModal">Edit Quantity</a>
                          </li>
                          <li><a href="{{url('print-preview-'.bin2hex($value->no_rkb))}}" class="print_prev " target="_blank">Print Preview </a>
                          </li>
                        </ul>
                    </div>
      </div>
