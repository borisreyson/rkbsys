...
@if($v->flag_message ==0)
                    <li style="border: 1px solid rgba(0,0,0,0.1);">
                      <a href="{{url('/sent/'.bin2hex($v->id_pesan))}}.message" class="row">
                        <label class="col-xs-12">
                         <span class="pull-left">To : {{$v->nama_lengkap}}</span>
                         <span class="pull-right">{{date("h.i A",strtotime($v->timelog))}}</span>
                        </label>
                ...
                <div class="x_title">
                  ...
                  <div class="sender-info">
                    <div class="row">
                      <div class="col-md-12">
                        <small>
                        <strong>@if($pesan->user_from==$_SESSION['username']) me @endif

                        </strong>
                        To
                        <strong>{{$pesan->nama_lengkap or ""}}</strong>
                        </small>
                      </div>
                    </div>
                  </div></h2>
...
<form class="form-horizontal" action="{{url('/inbox')}}" method="post">
