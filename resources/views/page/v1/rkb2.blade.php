...
$(document).on("click","button[id=btn_row]",function(){
  ...
  $("tr[id=new_row]").before("<tr>"+
               ...
               "</td>"+
               "<td><input type=\"text\" name=\"part_number[]\" class=\"form-control\" placeholder=\"Part Number\"></td>"+
               "<td>"+
               "<div class=\"input-group\" role=\"group\">"+
               "<span class=\"staticParent\">"+
               "<input type=\"number\" min=\"1\" step=\"0.5\" style=\"width:65px;\" name=\"quantity[]\" class=\"form-control child\" value=\"1\"></span>"+
