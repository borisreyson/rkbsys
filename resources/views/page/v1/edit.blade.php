...
new PNotify({
    ...
    function loadData() {
      ...
      $("tr[id=new_row]").before("<tr>"+
               ...
               '</select>'+
               '</td>'+
               '<input type="hidden" name="item[]" id="item" class="form-control" placeholder="Item" style="height:41px!important;" value="{{($v->part_name)}}" readonly>'+
               '<td><input type="text" name="part_number[]" id="part_number" style="height:41px!important;" class="form-control" placeholder="Part Number" value="{{($v->part_number)}}" readonly></td>'+
               '<td>'+
               '<div class="col-xs-6" role="group">'+
               '<span class="staticParent">'+
