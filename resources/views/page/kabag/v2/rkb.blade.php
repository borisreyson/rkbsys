...
@if(isset($_GET['expired'])!="")
  <a href="{{url('/kabag/rkb')}}" class="btn btn-default">RKB</a>
@else
...
<a href="{{url('/kabag/rkb')}}" class="btn btn-default">RKB</a>
@else
<a href="{{url('/kabag/rkb?close_rkb=all')}}" class="btn btn-default">RKB Close</a>
@endif
</div>
</div>
<div class="col-md-6 col-sm-12 col-xs-12">
...
<div class="col-sm-7" style="color: #000!important;">{{$value->myStatus}}</div>
        </div>
      </div>
      </div>
    </div>
