...
@endphp
                      <p>RKB {{$_SESSION['section']}} ({{($rkb_section?$rkb_section:'')}})</p>
                      <div class="">
...
@endphp
                      <p>RKB {{$_SESSION['section']}} Approve ({{$rkb_section_approve}})</p>
                      <div class="">
                        <div class="progress progress_sm" style="width: 100%;">
...
@endphp
                      <p>RKB {{$_SESSION['section']}} Waiting ({{$rkb_section_pending}})</p>
                      <div class="">
                        <div class="progress progress_sm" style="width: 100%;">
...
@endphp
                      <p>RKB {{$_SESSION['section']}} Cancel ({{$rkb_section_cancel}})</p>
                      <div class="">
                        <div class="progress progress_sm" style="width: 100%;">
...
<?php if($_SESSION['section']=="KTT"){  ?>
  ...
  <?php
    ...
    title_teks = "Line Graph RKB {{$_SESSION['department']}}";
    text_label = "{{$_SESSION['department']}}";
  <?php
}else{  ?>
    title_teks = "Line Graph RKB {{$_SESSION['section']}}";
    text_label = "{{$_SESSION['section']}}";
  <?php } ?>
