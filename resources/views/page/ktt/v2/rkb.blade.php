...
@if(isset($_GET['expired'])!="")
  <a href="{{url('/ktt/rkb')}}" class="btn btn-default">RKB</a>
@else
  <!--<a href="{{url('/ktt/rkb?expired=notnull')}}" class="btn btn-danger"> RKB EXPIRED</a>-->
@endif
@if(isset($_GET['close_rkb'])!="")
<a href="{{url('/ktt/rkb')}}" class="btn btn-default">RKB</a>
@else
<a href="{{url('/ktt/rkb?close_rkb=all')}}" class="btn btn-default">RKB Close</a>
@endif
</div>
</div>
<div class="col-md-6 col-sm-12 col-xs-12">
...
@endphp
    ...
    <div class="row box-height right_padd">
      <a href="#" data-id="{{$value->no_rkb}}" id="details" data-toggle="modal" data-target="#myModal">
...
<a href="#" class="btn btn-xs btn-danger" no-rkb="{{bin2hex($value->no_rkb)}}" id="cancel_rkb" class="" data-toggle="modal" data-target="#myModal">Cancel</a>
...
<input type="hidden" name="userTo" id="userTo" value="{{$value->nama_lengkap}}">
<input type="hidden" name="usernameTo" id="usernameTo" value="{{$value->user_entry}}">
<input type="hidden" name="norkb_to" id="norkb_to" value="{{$value->no_rkb}}">
