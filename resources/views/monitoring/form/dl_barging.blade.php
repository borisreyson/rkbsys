...
<div class="right_col" role="main">
	<div class="col-lg-12">
		...
		<a href="{{url('/monitoring/form/boat')}}">Form Delay Barging</a>
		<br>
		<br>
	</div>
	<div class="row">
...
<form class="form-horizontal" method="post" action="">
	...
	<div class="form-group">
		<div class="col-lg-offset-3 col-lg-3">
			...
			<a href="{{url('/monitoring/form/delay/barging')}}" class="btn btn-danger">Batal</a>  
		</div>
	</div>
</form>
	</div>
		...
		<table class="table table-bordered table-striped">
			...
			<tbody>
				...
				<tr style="background-color: red;color: white;">
					...
					<td><a style="color: white;" href="{{url('/monitoring/form/delay/barging/q-'.bin2hex($row->no))}}" class="btn btn-xs"><i class="fa fa-pencil"></i></a><a style="color: white;" href="{{url('/monitoring/form/delay/barging/undo-'.bin2hex($row->no))}}" class="btn btn-xs"><i class="fa fa-undo"></i></a></td>
				</tr>
				@else
				<tr>
					<td>{{date("d F Y",strtotime($row->tgl))}}</td>
					...
					<td>{{$row->keterangan}}</td>
					<td><a href="{{url('/monitoring/form/delay/barging/q-'.bin2hex($row->no))}}" class="btn btn-xs"><i class="fa fa-pencil"></i></a><a href="{{url('/monitoring/form/delay/barging/delete-'.bin2hex($row->no))}}" class="btn btn-xs"><i class="fa fa-trash"></i></a></td>
				</tr>
