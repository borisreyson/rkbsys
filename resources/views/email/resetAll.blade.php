...
<!-- page content -->
        <div class="col-md-12">
          <div class="col-middle">
            ...
            <div class="col-md-12 ">
             <form class="form-horizontal" <?php if(isset($user)){ ?> method="post" <?php }else{?> method="get" <?php } ?> action="">
            ...
            <?php } ?>
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="login" name="login" placeholder="Enter Username Or Nik" required="required" value="{{$user->username or ""}}">
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <p class="form-control-static" >{{$user->nama_lengkap or ""}}</p>
                </div>
              </div>
              <?php if(!isset($user)){ ?>
              <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                  <button type="submit" class="btn btn-default">Cek Username</button>
                </div>
              </div>
            <?php }else{ ?>
              ...
              <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                  <a href="{{url('/android/api/reset/all/password')}}" class="btn btn-danger">Reload</a>
                </div>
              </div>
            <?php } ?>
              <?php if(isset($user)){ 
                if($user==null){
                ?>
                <h4 style="color: red;">Error Data Tidak Ditemukan</h4>
              <?php }else{ ?>
                <input type="hidden" name="idUser" value="{{bin2hex($user->id_user)}}">
              <div class="form-group">
